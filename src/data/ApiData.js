...
const data = [
  {
    ...
    nameM: "المصروفات",
    type: "column",
    dataE: [300, 500, 3000000, 6000, 6000, 7000, 9000, 10000, 9000, 11000, 1200, 13000].sort((a, b) => b - a), //.sort((a, b) => b - a),
    dataM: [3000, 4000, 2000, 500, 400, 4000, 6000, 8000, 9000, 600, 1000, 1000].sort((a, b) => b - a),
  },
  {
    year_id: 2019,
    nameE: "الايرادات",
